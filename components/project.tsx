...
export default function Project({
	...
	return (
		...
		>
			<section
				className="relative bg-gray-100  bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-700 shadow-lg group dark:bg-gray-800 max-w-[80rem] dark:border-gray-700 rounded-2xl overflow-hidden 
        ...
        border-l-4 border-transparent group-hover:border-gray-700 dark:group-hover:border-gray-300"
			>
				...
				<div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 w-[99%] sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
					...
					<ul className="flex flex-wrap items-center align-middle place-content-center mt-4 gap-2 sm:mt-auto relative z-10">
						{tags.map((tag, index) => (
							<li
								key={index}
