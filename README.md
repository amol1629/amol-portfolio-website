...
<div align="center">
  <sub>⌁ &nbsp; <a href="#01--the-experience">EXPERIENCE</a> &nbsp; / &nbsp; <a href="#02--explore-the-world">ROUTES</a> &nbsp; / &nbsp; <a href="#03--launch-locally">SETUP</a> &nbsp; / &nbsp; <a href="#04--make-it-yours">CUSTOMIZE</a> &nbsp; / &nbsp; <a href="#05--ship-it">DEPLOY</a></sub>
</div>
...
### Built as a living interface

| **Foundation** | **Craft** | **Confidence** |
| :--- | :--- | :--- |
| App Router architecture · TypeScript-first components · reusable UI primitives | responsive composition · fluid scroll · glass surfaces · purposeful micro-interactions | loading and error states · metadata · sitemap · robots · manifest |
...
```text
GitHub repository  →  Vercel import  →  npm ci  →  npm run build  →  ✦ Live
```
